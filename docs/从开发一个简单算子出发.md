...
您可参考[环境准备](../README.md#二、环境构建)进行编译和测试环境搭建，环境准备好之后，就可以开始Solver的算子开发之旅。
...
CmatinvBatched算子实现主要包括：host侧实现和kernel侧实现。其中算子采用Kernel直调方式实现，Kernel直调算子开发流程可访问[Kernel直调算子开发-昇腾社区](https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/83RC1alpha002/opdevg/Ascendcopdevg/atlas_ascendc_10_0052.html)查看。

### Host侧开发

host侧负责参数校验、数据准备、Tiling计算和内存管理。Tiling开发的核心概念：`TilingData`、`Workspace`等，可访问[术语表-昇腾社区](https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/83RC1alpha002/opdevg/Ascendcopdevg/atlas_ascendc_10_00013.html)查看。
...
### Kernel侧开发
kernel侧负责实际的矩阵求逆计算。Kernel相关的`Compute`、`CopyIn`、`CopyOut`等概念，可访问[术语表-昇腾社区](https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/83RC1alpha002/opdevg/Ascendcopdevg/atlas_ascendc_10_00013.html)查看。
...
Input matrix batch 0 (first 3x3):
 [[ 6.138548  +6.138548j   -0.1382643 -1.4123037j   0.64768857+1.4656488j ]
 [ 1.5230298 -0.2257763j   8.184213  +8.184213j   -0.23413695-1.4247482j ]
 [ 1.5792128 -0.54438275j  0.7674347 +0.11092259j  7.912921  +7.912921j  ]]
Inverse matrix batch 0 (first 3x3):
 [[ 0.08008108-0.08207665j  0.01437852-0.00248317j -0.01324195+0.00764272j]
 [ 0.00181733+0.01696757j  0.0595009 -0.05867535j  0.01128552-0.00403378j]
 [ 0.00497235+0.01524625j -0.00147531+0.00781663j  0.0625691 -0.06477237j]]
Verification results for batch 0:
Max absolute error: 6.056e-08
Mean absolute error: 1.545e-08
Product of A and inv(A) (first 3x3):
 [[ 1.0000000e+00-8.97271146e-09j  4.5787600e-09+3.53360052e-09j
  -1.3785353e-08+4.97981034e-09j]
 [ 7.4361219e-09-5.77366954e-09j  9.9999994e-01+1.07189040e-08j
   1.5078854e-09-8.21158963e-09j]
 [-5.0239111e-09-9.87725013e-09j  5.9322796e-09-5.93227956e-09j
   1.0000000e+00-1.18236585e-08j]]
