...
- 算子规格：
    ...
    <tr>
        ...
        <td colspan="5" align="center">Sgetri</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td align="left">输入矩阵A，行主序，通常为Sgetrf分解后的L和U矩阵</td>
    ...
    <tr>
        ...
        <td colspan="5" align="center">sgetri_kernel</td>
    </tr>
    </table>
