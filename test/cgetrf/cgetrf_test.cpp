...
int main(int argc, char **argv)
{
    ...
    CHECK_RET(ReadFile("./test/cgetrf/data/input/A_gm.bin", aMatrixFileSize, A, aMatrixFileSize),
    ...
    WriteFile("./test/cgetrf/data/output/W_gm.bin", ipivData.data(), ipivData.size() * sizeof(int32_t));
