...
- 算子规格：
    ...
    <tr>
        ...
        <td colspan="5" align="center">Cgetrf</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td colspan="5" align="center">cgetrf_kernel</td>
    </tr>
    </table>
...
- 样例执行
  ```bash
  bash build.sh --ops=cgetrf --run # --ops=<算子名> --run可选参数，执行测试样例
  ```
  执行结果如下，说明精度对比成功。
  ```bash
